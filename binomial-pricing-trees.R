# Originally based on http://www.theresearchkitchen.com/archives/738
# Expanded to pre-allocate memory, use data frame instead of vectors,
# store option prices and early exercise flags.
